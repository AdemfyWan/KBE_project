...
C1 = 3.769488083  # MTOW vs payload ratio function, y-intercept
...
class Aircraft(GeomBase):
    ...
    #  propulsion system
    evaluate_battery = Input(False)  # toggles real battery capacity calculation with Q3D
...
# Q3D ==================================================================================================================
    ...
    @Attribute  # cruise cl is given as an input, while the angle of attack is calculated by q3d
    def cruise_cl(self):
...
# CG ANALYSIS ==========================================================================================================
    ...
    @Attribute  # airframe weight = remainder of MTOW after deduction by motor, payload, battery
    ...
    @Attribute  # overal cg x position = weighted average of airframe, payload, battery, motor
    ...
    def cg_analysis(self):
        ...
        plt.plot(self.cg_overall_x, 0, marker="x", markersize=10, color="red", label="Estimated CG")
...
#  STEP WRITER =========================================================================================================
    ...
    @Part
    def aircraft_solid_unscaled(self):
        return Fused(
    ...
    @Part  # scales solid to proper units
    def aircraft_solid(self):
        return ScaledShape(
            shape_in=self.aircraft_solid_unscaled,
