...
# CG analysis ----------------------------------------------------------------------------------------------------------
    ...
    def cg_plot(self):
        ...
        plt.plot(self.cg_airframe_x, 0, marker="x", markersize=10, color="red", label="Airframe CG")
