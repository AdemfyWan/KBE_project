...
# WINGS, ELEVONS, WINGLETS =============================================================================================
    ...
    def wing_assembly(self):
        return WingAssembly(
            ...
            twist=self.twist,
            fu_width=self.fu_width,
            elevon_chord_factor=self.elevon_chord_factor,
            elevon_span_factor=self.elevon_span_factor,
            elevon_spanwise_pos=self.elevon_spanwise_pos,
        )
...
#  STEP WRITER =========================================================================================================
    ...
    def step_writer_components(self):
        return STEPWriter(
            ...
            nodes=[self.body.assembly.main_body,
