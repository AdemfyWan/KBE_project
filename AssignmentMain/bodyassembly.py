...
# BODY & COMPARTMENT ===================================================================================================
    ...
    @Attribute  # maximum z coordinate of root airfoil (thickest point)
    def root_zmax_z(self):
        return max(self.body_full.root_airfoil.z_points)

    @Attribute  # x coordinate of root airfoil thickest point
    ...
    @Part  # used to generate compartment cover
    ...
    @Part  # main compartment volume with compartment cover indent taken into account
    def compartment_box2(self):
        return Box(
            height=self.root_zmax_z + 0.001,  # z // 0.001m indent for compartment cover
            length=self.fu_width * 0.75,  # y
    ...
    def compartment_translated(self):
        return TranslatedShape(shape_in=self.compartment_full,
                               displacement=Vector(0, 0, -0.003),  # shifts 0.003m for compartment cover thickness
                               color='red',
                               hidden=True)
    ...
    # @Part  # used for cross section checking
...
# MOTOR MOUNT ==========================================================================================================
    ...
    @Attribute  # calculates slope between motor mount rear surface top side and front edge which attaches to airfoil upper surface
